/**
* \brief Tranforms image into frequency spectrum
...
// TODO: (1) use more workitems (2) use more optimized version, (3) implement as string in dR_nodes_fft.c
