...
% calculate
for r = 2:rmax
   % in xc, which is a column array, are the cartesian x coordinates of a half circle stored, with radius r and center x0,y0.
   % in yc the y coordinates. in one degree incremenents, from 91 to 270.	
