...
These are reduced examples to give the intuition of how to use deepRacin. Therefore, configuration and data loading code is omitted. See examples/vgg16 or examples/squeezenet-v1.1 for a full examples of a networks for classification of the 1000 ILSVRC2012 classes.
